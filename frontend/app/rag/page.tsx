      ...
      <section className="max-w-5xl mx-auto grid gap-5">
        ...
        <Card>
          <CardContent className="pt-6 grid gap-2">
            ...
            <h1 className="text-gray-900 text-4xl font-semibold">RAG 问答</h1>
            <p className="text-gray-600 text-base leading-relaxed">
              当前页面调用后端 <code className="bg-gray-100 px-1 rounded text-sm">/api/rag/answer</code>，用于验证问答、检索元数据与 citation cards 的第一条前后端链路。
            </p>
          </CardContent>
        </Card>
