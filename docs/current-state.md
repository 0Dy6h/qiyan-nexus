...
6. 其它可选主线：network report export 后续增强（PDF/Word）；**runtime JSON → SQLite 已落地（2026-06-02，commit 4144357）**，PostgreSQL spike 仍为后续候选；**网络图可视化、hover/focus 高亮、键盘与箭头导航、e2e 回归均已落地**；Anthropic 仅在有订阅/key 后再排期。
7. 下一步候选：
