...
英文/技术副标题：Qiyan Nexus

一句话定位：面向特应性皮炎的中医药证据检索、RAG 问答与网络药理学科研工作台。

命名理由：
- “岐”来自岐黄，能指向中医药，但不直接使用“诊疗”这类容易带来医疗合规压力的词。
- “研”突出科研、文献、证据链和方法学协作。
- “枢”表示知识、文献、图谱、任务与报告的汇聚中枢。
- 比 Tcm_tech 更像产品名，也比“中医药精准诊疗与科研一体化平台”更短、更容易传播。

建议命名分层：
- 产品展示名：岐研枢
- 英文名：Qiyan Nexus
- 技术仓库名：tcm-tech 或 qiyan-nexus 均可；短期不建议立刻改目录名，避免破坏已有路径和脚本。
...
### 4.1 产品定位里“诊疗”表述过重
原名“中医药精准诊疗与科研一体化平台”容易让用户和监管侧理解为临床诊断/治疗系统。实际 MVP 更接近“证据检索 + 科研辅助 + 报告生成”。
...
### 5.1 新定位
岐研枢是一款面向特应性皮炎方向医生与科研人员的中医药证据与科研工作台，提供中英文文献检索、引用可追溯的 RAG 问答、PDF 文献管理，以及后续网络药理学与知识图谱分析。
...
### 第 1-2 天：收口命名与文档事实源
- 将 README、首页、metadata 的展示名改为“岐研枢”。
- 新增 ADR：前端实际版本基线。
...
立即改：
- README 标题与首页展示名从 Tcm_tech/长标题改为“岐研枢”。
...
推荐名称“岐研枢”可以承接中医药特色、科研定位和知识中枢的产品心智，同时降低医疗诊断承诺感。