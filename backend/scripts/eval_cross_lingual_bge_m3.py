"""Cross-lingual retrieval evaluation with bge-m3 backend.

Runs the 17-question bilingual subset of rag_ad_eval_questions across retrieval
strategies (keyword, vector, hybrid) with QIYAN_EMBEDDING_BACKEND=bge-m3.

Compares against the locked keyword baseline (avg_cross_lingual_recall=0.9688).

Usage:
    python scripts/eval_cross_lingual_bge_m3.py
    QIYAN_EMBEDDING_BACKEND=bge-m3 python scripts/eval_cross_lingual_bge_m3.py
"""
...
def main() -> int:
    ...
    print(f"# Cross-Lingual Retrieval Evaluation — bge-m3")
